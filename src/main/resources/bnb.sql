...
CREATE TABLE public.bookings (
    ...
    CONSTRAINT booking_user_fk FOREIGN KEY (user_id) REFERENCES _user(user_id)
);
...
-- Insert for rooms
INSERT INTO public.rooms (room_name, room_type, price_per_night, description, room_cover)
